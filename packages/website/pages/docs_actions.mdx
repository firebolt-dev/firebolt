...
Actions allow you to interact with your database or other server side code directly inside your components using the `useAction` hook:

```jsx title='components/NewsletterForm.js'
...
Action functions are completely removed from client bundles and will not be visible in any client bundles.
