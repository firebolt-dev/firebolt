...
Any `.mdx` file in the `routes` directory that exports a default component is treated as an MDX page in your app.
...
By default, MDX uses default elements such as `<h1>` and `<p>` but you can provide your own custom components using our [MDXProvider](/docs/ref/mdx-provider) in a parent layout.
