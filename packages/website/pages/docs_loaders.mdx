...
Loaders let you fetch data securely from a database (or anywhere else) using the [useData](/docs/ref/useData) hook:
...
Calling `data.read()` throws a promise to Suspense boundaries for loading UI while data is being fetched.
