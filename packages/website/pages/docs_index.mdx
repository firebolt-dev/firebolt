...
The `routes` directory is where all addressable content goes including layouts, pages, static and dynamic assets and api routes.

The `firebolt.config.js` file lets you configure your app including using plugins and middleware.
