...
The function is provided a [Context](/docs/ref/context) object as its first argument. The Context object has methods to access cookies and perform redirects.
